 ...
 * for you.
 */
 //$base_url = 'http://linkedeconomy.dd:8083';  // NO trailing slash!
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_LinkedEconomy_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_LinkedEconomy_dd.inc';
}
// </DDSETTINGS>
